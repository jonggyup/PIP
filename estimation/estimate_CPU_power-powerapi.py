...
#    "instructions", "cpu-cycles", "cpu-clock", "cache-misses"#,"cache-references"
...
def parse_perf_metrics():
    try:
        ...
        combined_values = perf_extracted_values
...
#        print(filtered_metrics_str)
        command = f'perf stat -e {filtered_metrics_str} -a -o ./perf_metrics.dat sleep 1'
...
#        estimate_power_kepler = predict_power_kepler(metrics)
        ...
        print(f"{estimate_power_powerapi:.2f} {truth:.2f}", flush=True)
