###### This version uses MAPE instead of MAE for loss function, compared with v1.1 ######
...
models = {
    'CatBoost': (
        CatBoostRegressor(verbose=0, loss_function='MAPE'),
        {
...
for model_name, (model, param_grid) in models.items():
    ...
    dump(best_model, f'../MLs/{model_name}_model-v1.2.joblib')
    ...
    mape = mean_absolute_percentage_error(labels_test, labels_pred) * 100
